  ...
  export default {
    ...
    methods:{
      ...
      send(){
        ...
        axios({
          type : "get", //提交方式
          url : "http://10.9.12.91:8080/goods/addGoods?name="+this.name+'?intro='+this.intro+'?color='+this.radio4+'?price='+this.price+'?typeid='+this.title.idw+'?pubdate='+this.pubdate+'?img='+this.dialogImageUrl+'?style='+this.radio5,
